...
//vertex shader decides the color for fragment shader
...
"#version 330 core\n"
"out vec4 FragColor;\n"
"uniform vec4 ourColor;\n" //for attribute that changes every frame
"void main()\n"
"{\n"
"   FragColor = ourColor;\n"
"}\n\0";
...
int main(){
    ...
    if (!success){//if shader couldn't compile
    ...
    while (!glfwWindowShouldClose(window)){
        ...
        float blueValue = static_cast<float>(sin(timeValue-1.5) / 2.0 + 0.5);
